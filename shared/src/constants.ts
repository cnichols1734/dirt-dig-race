export const BALANCE = {
  ...
  BOT: {
    EASY: {
      ...
      WILL_STEAL: false,
      WILL_ATTACK: false,
      WILL_USE_SONAR: false,
      WILL_USE_DYNAMITE: false,
      UPGRADE_ALL: false,
      PAUSE_CHANCE: 0.15,
      PREFERS_SOFT_TILES: false,
      TARGETS_SUPERCHARGED: false,
      DEFENDS_NODES: false,
      DIG_MULTI_PER_TICK: 1,
    },
    MEDIUM: {
      TICK_MS: 300,
      ...
      WILL_ATTACK: true,
      WILL_USE_SONAR: false,
      WILL_USE_DYNAMITE: true,
      UPGRADE_ALL: true,
      PAUSE_CHANCE: 0.05,
      PREFERS_SOFT_TILES: true,
      TARGETS_SUPERCHARGED: true,
      DEFENDS_NODES: false,
      DIG_MULTI_PER_TICK: 2,
    },
    HARD: {
      TICK_MS: 200,
